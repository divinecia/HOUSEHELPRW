...
class _FindHelpersPageState extends State<FindHelpersPage> {
  ...
  void _showHelperDetails(HouseHelperProfile helper) {
    showDialog(
      context: context,
      builder: (context) => HelperDetailsModal(
        helper: helper,
        onHirePressed: () {
          Navigator.of(context).pop(); // Close the modal
          Navigator.of(context).push(
            MaterialPageRoute(
              builder: (context) => HireHelperPage(helper: helper),
            ),
          );
        },
      ),
...
class HelperDetailsModal extends StatelessWidget {
  ...
  const HelperDetailsModal({
    super.key,
    required this.helper,
    required this.onHirePressed, // Add this
  });
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: ElevatedButton.icon(
                      onPressed: onHirePressed, // Use the callback instead
